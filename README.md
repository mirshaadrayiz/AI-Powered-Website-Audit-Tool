...
auditing <https://stripe.com>, or [`prompt_logs.md`](prompt_logs.md) for the fixed shape behind
every log — the system prompt, the user prompt template, the JSON Schemas for the structured input
and output, and how the call itself is orchestrated.
